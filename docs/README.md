...
- [Case Management PRD](./product/CASE_MANAGEMENT_PRD.md)
- [Work Breakdown Structure](./product/WORK_BREAKDOWN_STRUCTURE.md)
...
Contains guides and strategies for contributing to the ASTRA codebase.
...
- [Global Coding Standards](./standards/CODING_STANDARDS.md)
- [DevSecOps Standard](./standards/DEVSECOPS_STANDARD.md)
- [Documentation Lifecycle Standard](./standards/DOCUMENTATION_LIFECYCLE_STANDARD.md)
- [API Governance Standard](./standards/API_GOVERNANCE_STANDARD.md)
